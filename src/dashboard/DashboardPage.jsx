...
const DashboardPage = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen w-full bg-[#2E1D6A] text-white rounded-md">
      {/* Dashboard Content */}
      <div className="flex flex-col bg-[#2E1D6A] h-full w-full p-8 rounded-md">
        ...
        <h2 className="text-xl xl:text-3xl lg:text-3xl font-bold mb-8">Welcome back, {user.displayName}</h2>
              ...
              {additionalWorkflows.map(workflow => (
                <div key={workflow.id} className="bg-indigo-900 rounded-lg p-6 shadow-lg">
                  <div className="flex flex-col">
                    ...
                    <h4 className="text-lg font-medium text-left">{workflow.name}</h4>
                  ...
                  <div className="mb-10 overflow-x-auto py-2">
                    <div className="flex items-center min-w-max">
                      <div className="flex items-center">
                        <div className={`w-10 h-10 rounded-full ${currentStep >= 1 ? 'bg-indigo-600' : 'bg-indigo-800'} flex items-center justify-center flex-shrink-0`}>
                          <span>1</span>
                        </div>
                        <span className="ml-3 text-base whitespace-nowrap">Select Workflows</span>
                      </div>
                      <div className="w-20 h-1 bg-indigo-700 mx-4 flex-shrink-0"></div>
                      <div className="flex items-center">
                        <div className={`w-10 h-10 rounded-full ${currentStep >= 2 ? 'bg-indigo-600' : 'bg-indigo-800'} flex items-center justify-center flex-shrink-0`}>
                          <span>2</span>
                        </div>
                      ...
                      <div className="w-20 h-1 bg-indigo-700 mx-4 flex-shrink-0"></div>
                      <div className="flex items-center">
                        <div className={`w-10 h-10 rounded-full ${currentStep >= 3 ? 'bg-indigo-600' : 'bg-indigo-800'} flex items-center justify-center flex-shrink-0`}>
                          <span>3</span>
                        </div>
